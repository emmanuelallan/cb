        ...
        {isExpanded && (
          <>
            <p className="w-full overflow-hidden para-control">
              ...
              ordered an in-depth examination to get to the bottom of what’s
              going on. Unfortunately, this essential test comes with a hefty
              price tag – $1500 – and it needs to be done at Aga Khan Hospital.
            </p>
            ...
            <p className="w-full overflow-hidden para-control">
              ...
              believe in the power of community, music, and coming together for
              a good cause. So, I’ve decided to do what I do best – create
              something meaningful. I’ve put together a 10-song LoFi-Afrobeat EP
              that I’m offering to help raise the funds Ambros needs.
            </p>
            ...
            <p className="w-full overflow-hidden para-control">
              🎶 $20 – Get the full 10-song EP and experience the entire
            ...
            <p className="w-full overflow-hidden para-control">
              ...
              you’ll also be supporting an artist trying to make a positive
